...
def send_user_invitation_email(
    *,
    ...
    """Send login credentials to a newly invited team member."""
    ...
    <div style="font-family:Arial,sans-serif;max-width:580px;margin:auto;padding:32px;background:#F3F7FF;border-radius:12px;">
      <div style="background:linear-gradient(135deg,#4A57B9,#6F80E8);padding:28px 24px;border-radius:10px;text-align:center;">
        <h1 style="color:#fff;margin:0;font-size:22px;">You have been invited to HSE Platform</h1>
      ...
      <div style="background:#ffffff;padding:32px 28px;border-radius:10px;margin-top:12px;">
        ...
        <p style="color:#374151;font-size:14px;line-height:1.6;">
          ...
          {f'for site <strong>{site}</strong>' if site else ''} on the HSE Platform.
        </p>
        ...
        <div style="text-align:center;margin:28px 0 20px;">
          <a href="{login_url}" style="background:linear-gradient(135deg,#4A57B9,#6F80E8);color:#fff;padding:13px 32px;border-radius:8px;text-decoration:none;font-weight:700;font-size:15px;display:inline-block;">
            Login to HSE Platform
          </a>
        </div>
      </div>
      <div style="padding:16px 4px 0;text-align:center;">
        <p style="color:#9CA3AF;font-size:11px;margin:0;">We recommend changing your password after your first login.</p>
      </div>
    </div>
    """
